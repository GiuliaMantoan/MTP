...
sheetName = varnames2{1}; % select the variable
...
actualvar_oil = interm(1:13,:);

clearvars -except mtestdata start_date end_date covid_date ctrynames varnames2 fullFileName actualvar_oil momentlist outputFolder actualvar
