function Zb = overlapping_bst_SL(Z,b)
...
while collinearity == true
    ...
    % if all zeros or or all 1 true and so repeat the loop as there is collinearity otherwsie false
    collinearity = all(lastCol == 0) || all(lastCol == 1);
