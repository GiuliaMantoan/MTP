function [mean_value, std_dev, skewness, kurtosis, delta, mu,omega] = moments_skewt_distr_sm(loc, scale, shape, df)
    ...
    omega = sqrt(scale); % here there is a potential mistake --> should be the scale itself - not the square root
    ...
    kurtosis = (fourth_central_moment / (std_dev^4)) - 3; % this is wromng. U need to kill -3
